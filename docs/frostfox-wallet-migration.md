...
## Active-request snapshot policy (2026-09-10, deployed)
...
This policy is not a per-user administrative bypass. Authentication, the inclusive USD 1 proof for a new transfer, receipt ownership, conflicting legacy freeze protection and FrostFox's unique pending/credit transaction remain mandatory.

NewAPI source `5e18656e4e119eb3ace523854c3b039cfb2167e3`, image `sha256:4000bc737364df9eb8ffaf93236f5cbb538b5391ab396902faa1bbe73856c53e`, began serving through the standard instance at 2026-09-10 06:13:04 UTC. The candidate drained and was removed at 06:15:17 UTC. FrostFox source `0409a8f653e8c75cef517ad3191e9cf19ff97b08` completed its guarded blue/green release at 06:37:25 UTC. Later documentation commits are not deployed source identities.

Both real Dockerfiles built successfully; the pinned NewAPI source passed 7 real PostgreSQL test groups / 14 leaf scenarios covering competing wallet locks, late deltas, affiliate writers, owned replay and transaction rollback. During cutover, only the exact public migration endpoint was temporarily guarded until the old full-User invitation writer exited; migration mode stayed enabled everywhere. Normal routes continued serving and both old/candidate processes drained naturally. Authenticated synthetic inspect from FrostFox passed without financial writes. No customer transfer or activity reset was performed. Existing upstream errors and deleted-user TokenAuth errors remain separate unresolved issues. Full release and backup evidence: FrostFox `doc/审计记录/REL-20260910-请求中钱包迁移快照发布.md`.
