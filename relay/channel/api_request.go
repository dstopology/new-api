...
func sendPingData(c *gin.Context, mutex *sync.Mutex) error {
	...
	// Bound the write so the caller can always wait for this goroutine before
	// Gin recycles the request context.
...
func doRequest(c *gin.Context, req *http.Request, info *common.RelayInfo) (*http.Response, error) {
	...
	if info.IsStream {
		...
		pingEnabled, pingInterval := helper.RelayPingConfig(info, generalSettings)
		if pingEnabled {
