...
func InitOptionMap() {
	...
	common.OptionMap["InviteTopupRebateValidDays"] = strconv.Itoa(common.InviteTopupRebateValidDays)
	...
	common.OptionMap["RetryIntervalMilliseconds"] = strconv.Itoa(common.RetryIntervalMilliseconds)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InviteTopupRebateRatio":
		common.InviteTopupRebateRatio, _ = strconv.ParseFloat(value, 64)
	case "InviteTopupRebateValidDays":
		common.InviteTopupRebateValidDays, _ = strconv.Atoi(value)
	...
	case "RetryIntervalMilliseconds":
		common.RetryIntervalMilliseconds, _ = strconv.Atoi(value)
