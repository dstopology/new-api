...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/node-studio/handoff", middleware.TryUserAuth(), controller.NodeStudioHandoff)
		...
		{
			userRoute.POST("/register", middleware.CriticalRateLimit(), middleware.TurnstileCheckAndConsume(), controller.Register)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/invite_codes", controller.GetSelfInviteCodes)
				selfRoute.POST("/invite_codes", controller.CreateSelfInviteCodes)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/admin/invite_codes", controller.GetAllInviteCodes)
				adminRoute.GET("/admin/invite_codes/search", controller.SearchInviteCodes)
				adminRoute.POST("/admin/invite_codes", controller.CreateInviteCodes)
				adminRoute.PUT("/admin/invite_codes", controller.UpdateInviteCode)
				adminRoute.DELETE("/admin/invite_codes/:id", controller.DeleteInviteCode)
				...
				adminRoute.PUT("/:id/rpm_limits", controller.UpdateUserGroupRpmLimit)
		...
		logRoute.GET("/:id/archive", middleware.AdminAuth(), controller.GetLogArchive)
		logRoute.GET("/:id/failure_record", middleware.AdminAuth(), controller.GetRequestFailureLog)
